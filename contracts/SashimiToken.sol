...
contract ERC20Capped is ERC20Mintable {
    ...
    contract SashimiToken is ERC20Capped(1200000000 * (10 ** uint256(18))) {
    // token details
    string public constant name = "SashimiToken";
    string public constant symbol = "SASHTOKEN";
    uint8 public constant decimals = 18;
    
    // initial supply of token
    uint256 public constant INITIAL_SUPPLY = 12000 * (10 ** 5) * (10 ** uint256(decimals));

    uint8 public constant NETWORK_ID = 2;
    ...
    */
    function burnToken(uint256 value, string memory data) public {
        emit BurnRequestLog(nonce, msg.sender, value, hashDetails(nonce, msg.sender, value, NETWORK_ID), data);
        doBurnToken(msg.sender, value, data);
    }
    ...
    */
    function burnToken(uint256 value) public {    
      emit BurnRequestLog(nonce, msg.sender, value, hashDetails(nonce, msg.sender, value, NETWORK_ID), "");
      doBurnToken(msg.sender, value.sub(transferFee), "");
    }
    ...
    */
    ...
    /**
    * @dev Function to set is mint pause.
    ...
    */
    ...
    /**
    * @dev Function to set mint pause address.
    * @param newAddress New address who can set mint pause status.
    */
    function setMintPauseAddress(address newAddress) public onlyMinter {
    ...
    */
    function hashDetails(uint256 id, address burner, uint256 value, uint8 networkID) 
    internal pure returns (bytes32) {
        return keccak256(abi.encodePacked(id, burner, value, networkID));
    }
    ...
    * @param data String of description.
    */
    function doBurnToken(address account, uint256 value, string memory data) private {
        _burn(account, value);
        emit BurnLog(nonce, msg.sender, value, hashDetails(nonce, msg.sender, value, NETWORK_ID), data);
        nonce = nonce.add(1);
    }
}